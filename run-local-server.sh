...
export PAYMENT_POLICY_STORE_BACKEND="${PAYMENT_POLICY_STORE_BACKEND:-${HEDERA_POLICY_STORE_BACKEND:-firestore}}"
export PAYMENT_POLICY_EVIDENCE_STORE_BACKEND="${PAYMENT_POLICY_EVIDENCE_STORE_BACKEND:-firestore}"
